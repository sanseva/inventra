...
<body class="font12">
	...
	<table class="bordered_table">
		...
		<tr>
			<td>
				<font style='font-size:14px;text-align:center;margin: auto;display: block;padding-top: 20px;'>TAX INVOICE<br/>Original For Receipt</font>
				<br />
				<br />
					<?php
					$year ="";
					...
					<table width="100%" class="no_bordered_table">
							 <tr>
							 	<td>
							 	<font size=2>INVOICE NO : <!-- AO --><?=$year?>/<?=str_pad($invoice_no,"3","0",STR_PAD_LEFT) ;?></font>
								
								</td>
							
							 	<td align="right">
							 	<font size=2> Dated: <?=$billDate;?></font>
								</td>
							</tr>
					...
					<div style="font-size:12px;">
					 ...
					 <!--<table class="bordered_table" border="1" cellpadding='10'>
					  ...
					  <table class="bordered_table" cellpadding='7' style="font-size:12px;border-left:0px !important;width: 100%;">
						...
						<tr>
							<td class="" colspan="5" valign="top" style='border:0px;' >
								<br><br>
		...
		<tr>
			<td style='border-top:0px;'><small>GSTIN: <?= $this->session->userdata('GSTIN');?>, PAN: <?= @$this->session->userdata('PAN');?></small></td>
		</tr>
	</table>
