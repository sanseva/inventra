			            ...
			            foreach($products as $item){
			              ...
			              <tr>
			              	<?php 
			              	 ...
			              	 ?>
			              	<td class="text-right" colspan="4"><strong>DUE DATE </strong></td>
...
<!--	<tr><td><small>GSTIN: <?= $this->session->get('GSTIN');?>, PAN: <?= @$this->session->get('PAN');?></small></td></tr>-->
	...
	<strong>GSTIN NO : </strong><?= $this->session->get('DLno');?><br/>
	<strong>STATE : </strong><?=state_id_name($this->session->get("state_id"))?><br/><br/>
