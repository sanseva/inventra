...
<body data-menu-color="light" data-sidebar="default">
        ...
        <div class="content-page">
            ...
            <div style="padding-top:30px;padding-right:50px;" class="d-flex flex-wrap gap-2">
                <button type="button" class="btn btn-primary ms-auto" data-bs-toggle="modal"
                    data-bs-target=".bs-example-modal-center">ADD MODULE</button>
            </div>
                                ...
                                <form action="javascript:void(0);" id="myForm" method="post">
                                    <div class="row g-3">
                                        <div class="col-xxl-12">
                                            <div>
                                                <label for="mname" class="form-label">Module Name</label>
                                        ...
                                        <div class="col-xxl-12">
                                            <div>
                                                <label for="Module Description" class="form-label">Module Description</label>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title text-black mb-0">MODULE LIST</h5>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
        ...
        var table = $('#datatable-buttons').DataTable({
            ...
            ajax: {
                url: '<?php echo base_url();?>permission/getmodule', // Replace with the server-side URL
                type: 'GET',
    ...
    if (confirm('Are you sure you want to delete this record?')) {
        $.ajax({
            url: '<?php echo base_url();?>permission/deletedata', // Server-side script for deletion
            method: 'POST',
            data: { id: id },
    ...
    $(document).ready(function() {
        ...
        $('#myForm').on('submit', function(e) {
            ...
            {
                $.ajax({
                    url: '<?php echo base_url();?>permission/save_data',// The PHP file that will process the data
                    type: 'POST',
                    data: dataToSend,
                    success: function(response) {
            ...
            {
                $.ajax({
                    url: '<?php echo base_url();?>permission/update_data',// The PHP file that will process the data
                    type: 'POST',
                    data: dataToSend,
                    success: function(response) {
    ...
    function edit(id)
    {
         // Perform AJAX request
         $.ajax({
                url: '<?php echo base_url();?>permission/getdatabyid',// The PHP file that will process the data
                type: 'POST',
                data: { id: id },
                success: function(response) {
                        $("#mname").val(response[0].mname);
                        
                        $("#mdesc").val(response[0].mdesc);
   
                        $("#action").val('update');
                        $("#idd").val(response[0].mid);
