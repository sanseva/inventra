                ...
                <div class="col-md-6 col-xl-6">
                    <div class="card text-center p-4">
                        <div class="card-header">
                            <h5 class="card-title text-black mb-0">ACCESS DENIED</h5>
                        </div>
                        <div class="card-body">
                            <div class="lock-icon">🔒</div>
                            <h5 class="text-danger mt-3">Access Denied</h5>
                            <p class="text-muted">You do not have permission to access this section.</br>Contact Administrator</p>
                        </div>
                    </div>
                </div>
            </div>
