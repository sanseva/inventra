                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title text-black mb-0">Community Care</h5>
                        </div>
                    </div>
                                    ...
                                    <table id="datatable-buttons"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th nowrap>Claim Number </th>
                                                <th nowrap>Date of Service </th>
                                            </tr>
                                        </thead>
                                        <tbody id="shodata">
                                        <form action="<?= site_url('communitycare/save_excel') ?>" method="post">
                                     ...
                                     <!-- Hidden field to pass the full JSON data to the controller -->
                                     <input type="hidden" name="excel_data" value='<?= esc($rawJson, 'html') ?>'>
